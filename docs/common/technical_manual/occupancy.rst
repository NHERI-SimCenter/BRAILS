...
The trained classifier is tested on a ground truth dataset `dataset <https://zenodo.org/record/4553803/files/occupancy_validation_images.zip>`_.
The accuracy, precision, recall and F1 are all found to be 100%.
